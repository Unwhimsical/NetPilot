...
<details>
<summary>展开查看被豁免的代理规则（21 条）</summary>
...
### 🛡️ 白名单豁免（去广告规则，共 26 条）

**原因**：这些域名在 `direct_whitelist.txt` 中，已从去广告规则中移除，避免误拦截。

<details>
<summary>展开查看被豁免的去广告规则（26 条）</summary>
...
🩺 Shield模块: 健康检查通过（220812 条规则，10.2 MB）

✅ Shield 模块已写入，代理 27331 条，去广告 193481 条
...
- ✅ https://raw.githubusercontent.com/GMOogway/shadowrocket-rules/master/sr_direct_list.module
  - 成功 40 次，失败 0 次，连续失败 0 次
  - 最近成功: 2026-09-16 23:44:10
  - 最近失败: 无 

- ✅ https://raw.githubusercontent.com/GMOogway/shadowrocket-rules/master/sr_proxy_list.module
  - 成功 40 次，失败 0 次，连续失败 0 次
  - 最近成功: 2026-09-16 23:44:25
  - 最近失败: 无 
