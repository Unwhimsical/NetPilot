...
**运行时间**: 2026-09-18 12:09:07 北京时间

---

## 直连模块

### 🔍 过滤海外/强制代理直连规则（共 932 条）
...
🩺 直连模块: 健康检查通过（110304 条规则，3.5 MB）

✅ 直连模块已写入，共 110304 条规则
...
<details>
<summary>展开查看被豁免的代理规则（18 条）</summary>
...
- `DOMAIN-SUFFIX,spotifycdn.com,PROXY`
  - 匹配白名单：`spotifycdn.com`
  - 用途：Spotify CDN（封面、静态资源）
...
- `DOMAIN-SUFFIX,scdn.co,PROXY`
  - 匹配白名单：`scdn.co`
  - 用途：Spotify 音频 CDN（歌曲流媒体）

</details>

### 🛡️ 白名单豁免（去广告规则，共 25 条）

**原因**：这些域名在 `direct_whitelist.txt` 中，已从去广告规则中移除，避免误拦截。

<details>
<summary>展开查看被豁免的去广告规则（25 条）</summary>
...
<details>
<summary>展开查看新增去广告规则（共 382 条）</summary>

```
DOMAIN-SUFFIX,otl.minefun.io,REJECT
DOMAIN-SUFFIX,yindsxogkykru.space,REJECT
DOMAIN-SUFFIX,apogaicodinitepurler.cyou,REJECT
DOMAIN-SUFFIX,vitalbreak.pro,REJECT
DOMAIN-SUFFIX,cblsllkemnyel.site,REJECT
DOMAIN-SUFFIX,aykqyjzoqveba.top,REJECT
DOMAIN-SUFFIX,pxrlnftjhjrne.site,REJECT
DOMAIN-SUFFIX,lienishonwqtd.com,REJECT
DOMAIN-SUFFIX,flexingjonas.qpon,REJECT
DOMAIN-SUFFIX,isnwvcmuobaol.space,REJECT
DOMAIN-SUFFIX,hagridpnxt.com,REJECT
DOMAIN-SUFFIX,xffdhyplpiqxd.website,REJECT
DOMAIN-SUFFIX,teacartsublist.qpon,REJECT
DOMAIN-SUFFIX,dgysewmj.com,REJECT
DOMAIN-SUFFIX,papyraldanai.com,REJECT
DOMAIN-SUFFIX,alexasdisbuds.shop,REJECT
DOMAIN-SUFFIX,gbgblvdsgslmy.site,REJECT
DOMAIN-SUFFIX,taberedscaups.qpon,REJECT
DOMAIN-SUFFIX,januaryyerbas.com,REJECT
DOMAIN-SUFFIX,5r4k1q7utfynrwy.rest,REJECT
DOMAIN-SUFFIX,grebespashes.shop,REJECT
DOMAIN-SUFFIX,pionicmoroncy.cfd,REJECT
DOMAIN-SUFFIX,ytjyfovtkbraq.space,REJECT
DOMAIN-SUFFIX,zipejkcnhfgjl.site,REJECT
DOMAIN-SUFFIX,dagong.org,REJECT
DOMAIN-SUFFIX,rotundotorma.cyou,REJECT
DOMAIN-SUFFIX,bkcubzzabtoda.site,REJECT
DOMAIN-SUFFIX,reslatescrim.qpon,REJECT
DOMAIN-SUFFIX,unfrailoutsea.cyou,REJECT
DOMAIN-SUFFIX,dklbwqjzpscsj.space,REJECT
DOMAIN-SUFFIX,tirritbijous.qpon,REJECT
DOMAIN-SUFFIX,stifferfallage.cyou,REJECT
DOMAIN-SUFFIX,ghmuxiwdqdqle.online,REJECT
DOMAIN-SUFFIX,vain-cause.pro,REJECT
DOMAIN-SUFFIX,basilsliras.shop,REJECT
DOMAIN-SUFFIX,sogaromney.qpon,REJECT
DOMAIN-SUFFIX,zincedbyrlveta.cfd,REJECT
DOMAIN-SUFFIX,sauhvupw.com,REJECT
DOMAIN-SUFFIX,dyaouhtteoorlu.com,REJECT
DOMAIN-SUFFIX,salmochufa.com,REJECT
DOMAIN-SUFFIX,msfevrhvdychf.online,REJECT
DOMAIN-SUFFIX,rzejwwdejhvqr.online,REJECT
DOMAIN-SUFFIX,gjkazbhmaicel.website,REJECT
DOMAIN-SUFFIX,peakilyracists.com,REJECT
DOMAIN-SUFFIX,95d684gnf.com,REJECT
DOMAIN-SUFFIX,hsefhnuodtav.com,REJECT
DOMAIN-SUFFIX,gaffkyamisura.shop,REJECT
DOMAIN-SUFFIX,csmzticvczsrs.online,REJECT
DOMAIN-SUFFIX,ugckdqswxxhav.com,REJECT
DOMAIN-SUFFIX,anisilsamiel.com,REJECT
DOMAIN-SUFFIX,mbsbfchlytjy.com,REJECT
DOMAIN-SUFFIX,xrmkvbidvmrsz.online,REJECT
DOMAIN-SUFFIX,dzpnheknnjwmdh.com,REJECT
DOMAIN-SUFFIX,ciwzftpqjdzdh.site,REJECT
DOMAIN-SUFFIX,tzwuxckycugtl.website,REJECT
DOMAIN-SUFFIX,u6vlqrwcv.com,REJECT
DOMAIN-SUFFIX,browser-intake-datadoghq.eu,REJECT
DOMAIN-SUFFIX,fe7xxmtg3.com,REJECT
DOMAIN-SUFFIX,wylespectuprises.qpon,REJECT
DOMAIN-SUFFIX,sxesrtztohsqb.website,REJECT
DOMAIN-SUFFIX,fhjzilsvfpouc.site,REJECT
DOMAIN-SUFFIX,hobblertactile.cfd,REJECT
DOMAIN-SUFFIX,resectnonbusyasta.cfd,REJECT
DOMAIN-SUFFIX,emparkfluky.shop,REJECT
DOMAIN-SUFFIX,clowdersin.qpon,REJECT
DOMAIN-SUFFIX,qinipsygrpahl.space,REJECT
DOMAIN-SUFFIX,popxuoiefktgv.com,REJECT
DOMAIN-SUFFIX,pccitbsqibmsu.site,REJECT
DOMAIN-SUFFIX,fhvtzymzzcngw.website,REJECT
DOMAIN-SUFFIX,wbozvildyxxmb.website,REJECT
DOMAIN-SUFFIX,pullinglocable.cfd,REJECT
DOMAIN-SUFFIX,zyzqkbkqmazwz.top,REJECT
DOMAIN-SUFFIX,kolkozeditsbusker.cfd,REJECT
DOMAIN-SUFFIX,7x7ifycmw6i649enq.rest,REJECT
DOMAIN-SUFFIX,nlvxcyxcnwxlp.space,REJECT
DOMAIN-SUFFIX,dizaineklam.cfd,REJECT
DOMAIN-SUFFIX,dc32ac9846.com,REJECT
DOMAIN-SUFFIX,xmkkpkcyxhxau.site,REJECT
DOMAIN-SUFFIX,qzszyjemfjdsa.website,REJECT
DOMAIN-SUFFIX,bvsmoqqq.com,REJECT
DOMAIN-SUFFIX,xwnakfcdldo.com,REJECT
DOMAIN-SUFFIX,babooseducate.cyou,REJECT
DOMAIN-SUFFIX,pishedbyssal.com,REJECT
DOMAIN-SUFFIX,ensealplaners.com,REJECT
DOMAIN-SUFFIX,cpsdlldwvosol.space,REJECT
DOMAIN-SUFFIX,pistickjowled.cyou,REJECT
DOMAIN-SUFFIX,avzwgvitrfmsbg.com,REJECT
DOMAIN-SUFFIX,asfbvawqabjaz.space,REJECT
DOMAIN-SUFFIX,muskiespalatia.cfd,REJECT
DOMAIN-SUFFIX,j17xor750.com,REJECT
DOMAIN-SUFFIX,tdxvywascdazw.online,REJECT
DOMAIN-SUFFIX,pedatabalsaupflows.cfd,REJECT
DOMAIN-SUFFIX,zanderaswirl.com,REJECT
DOMAIN-SUFFIX,coccoussparsim.cyou,REJECT
DOMAIN-SUFFIX,muriatenuttery.qpon,REJECT
DOMAIN-SUFFIX,oafdomglewterefah.cfd,REJECT
DOMAIN-SUFFIX,azdctjsysrsxa.online,REJECT
DOMAIN-SUFFIX,overfewcigua.shop,REJECT
DOMAIN-SUFFIX,zdr6wn2f5.com,REJECT
DOMAIN-SUFFIX,rhxdnsvdqfsek.com,REJECT
DOMAIN-SUFFIX,rhczdhojmpcdp.online,REJECT
DOMAIN-SUFFIX,codingskysail.com,REJECT
DOMAIN-SUFFIX,jyozavojlraeb.top,REJECT
DOMAIN-SUFFIX,sepsidsarges.cfd,REJECT
DOMAIN-SUFFIX,hagglebudh.cfd,REJECT
DOMAIN-SUFFIX,plumbogcrepy.shop,REJECT
DOMAIN-SUFFIX,dopersmillets.shop,REJECT
DOMAIN-SUFFIX,ctogdpoqpvduz.website,REJECT
DOMAIN-SUFFIX,hqbttzzvympnn.website,REJECT
DOMAIN-SUFFIX,secondhandbrave.pro,REJECT
DOMAIN-SUFFIX,ihmmmcoobnhxj.website,REJECT
DOMAIN-SUFFIX,andvarimoutler.qpon,REJECT
DOMAIN-SUFFIX,sleezyduppy.cfd,REJECT
DOMAIN-SUFFIX,qvvxofanhglic.site,REJECT
DOMAIN-SUFFIX,stourlyakepiro.cfd,REJECT
DOMAIN-SUFFIX,pavesgrainykai.qpon,REJECT
DOMAIN-SUFFIX,inditedstooged.cyou,REJECT
DOMAIN-SUFFIX,untrillwalty.cfd,REJECT
DOMAIN-SUFFIX,rjhblp11gb7n1vxm.rest,REJECT
DOMAIN-SUFFIX,vdvfyhpszecde.site,REJECT
DOMAIN-SUFFIX,cottedhotchanema.qpon,REJECT
DOMAIN-SUFFIX,fraysblotto.cyou,REJECT
DOMAIN-SUFFIX,scrauchfolic.com,REJECT
DOMAIN-SUFFIX,jmhkdmwemnkgq.website,REJECT
DOMAIN-SUFFIX,ucksefztiyvnx.site,REJECT
DOMAIN-SUFFIX,9cmhbqnwor9iml8je.rest,REJECT
DOMAIN-SUFFIX,wmxwrbcgiyyzk.website,REJECT
DOMAIN-SUFFIX,flankerwhits.cfd,REJECT
DOMAIN-SUFFIX,ssifumonehvyc.space,REJECT
DOMAIN-SUFFIX,nakerpaijama.com,REJECT
DOMAIN-SUFFIX,bloteshapes.cyou,REJECT
DOMAIN-SUFFIX,y9rtbzrt648fuikwyrvpgqehjl1.cfd,REJECT
DOMAIN-SUFFIX,centassels.com,REJECT
DOMAIN-SUFFIX,derbytestulebimini.qpon,REJECT
DOMAIN-SUFFIX,kfmifmxgjznjy.space,REJECT
DOMAIN-SUFFIX,muddlingthroughcode.com,REJECT
DOMAIN-SUFFIX,wouhhfarrpkfz.online,REJECT
DOMAIN-SUFFIX,hzeartjirlhdv.site,REJECT
DOMAIN-SUFFIX,uommkiivgnfkd.online,REJECT
DOMAIN-SUFFIX,bvmgyjbhzsuti.website,REJECT
DOMAIN-SUFFIX,cainianmarts.shop,REJECT
DOMAIN-SUFFIX,btgjxrcjhfuwx.site,REJECT
DOMAIN-SUFFIX,motiflegua.qpon,REJECT
DOMAIN-SUFFIX,99wfzh2p2iqn8w84ui.cfd,REJECT
DOMAIN-SUFFIX,ppidyzfzhhthj.space,REJECT
DOMAIN-SUFFIX,rljxjlsucxlmh.website,REJECT
DOMAIN-SUFFIX,83b803c2d5.com,REJECT
DOMAIN-SUFFIX,neighborhoodbiketours.com,REJECT
DOMAIN-SUFFIX,smoppleuncase.com,REJECT
DOMAIN-SUFFIX,dobytowsy.com,REJECT
DOMAIN-SUFFIX,bhartiburdens.shop,REJECT
DOMAIN-SUFFIX,phacoidmirkest.com,REJECT
DOMAIN-SUFFIX,lkvhxhhupt.com,REJECT
DOMAIN-SUFFIX,www.bjseverlastingoils.com,REJECT
DOMAIN-SUFFIX,laiqrddhcqstl.space,REJECT
DOMAIN-SUFFIX,akbanyfaujras.online,REJECT
DOMAIN-SUFFIX,dijrtichfghgw.site,REJECT
DOMAIN-SUFFIX,aakbsrffmrrae.site,REJECT
DOMAIN-SUFFIX,formollooney.cfd,REJECT
DOMAIN-SUFFIX,hhtzqdpufbpnl.online,REJECT
DOMAIN-SUFFIX,fartmalthus.shop,REJECT
DOMAIN-SUFFIX,madqwcbhobeca.space,REJECT
DOMAIN-SUFFIX,ilxilmadwxfah.space,REJECT
DOMAIN-SUFFIX,benighttibertoutword.cyou,REJECT
DOMAIN-SUFFIX,5thu3nutpnc55uoonx4w.rest,REJECT
DOMAIN-SUFFIX,yatmxgfvgwpthj.com,REJECT
DOMAIN-SUFFIX,bouncyrerate.cyou,REJECT
DOMAIN-SUFFIX,quotedbaybush.qpon,REJECT
DOMAIN-SUFFIX,2xgjpuly4vj9e932n.cfd,REJECT
DOMAIN-SUFFIX,kvmxbbhgynyqqus.com,REJECT
DOMAIN-SUFFIX,pmkdisodic.cfd,REJECT
DOMAIN-SUFFIX,mastaxdefalk.com,REJECT
DOMAIN-SUFFIX,fishingrodsgalore.com,REJECT
DOMAIN-SUFFIX,tumbekmetage.com,REJECT
DOMAIN-SUFFIX,www.damncheapguns.com,REJECT
DOMAIN-SUFFIX,wjualftrzhelu.site,REJECT
DOMAIN-SUFFIX,qrk18b4ik735ve.cfd,REJECT
DOMAIN-SUFFIX,wywkwqzwzokmm.top,REJECT
DOMAIN-SUFFIX,zymapiwvoeisq.space,REJECT
DOMAIN-SUFFIX,xrbxqqyscduwx.site,REJECT
DOMAIN-SUFFIX,gmgxvqlzpzzkw.online,REJECT
DOMAIN-SUFFIX,szluwimnygffe.site,REJECT
DOMAIN-SUFFIX,wcqoyugiqivdp.online,REJECT
DOMAIN-SUFFIX,bandhuninoxnonuse.cyou,REJECT
DOMAIN-SUFFIX,qbrzvovbwqwqz.top,REJECT
DOMAIN-SUFFIX,rjqzljvzearza.top,REJECT
DOMAIN-SUFFIX,fpjviyeeolrpi.space,REJECT
DOMAIN-SUFFIX,velouteentonic.cfd,REJECT
DOMAIN-SUFFIX,frail-active.pro,REJECT
DOMAIN-SUFFIX,gdeppehq.com,REJECT
DOMAIN-SUFFIX,ebafewbwwguab.space,REJECT
DOMAIN-SUFFIX,blarinahiate.com,REJECT
DOMAIN-SUFFIX,bajoiretoxoid.shop,REJECT
DOMAIN-SUFFIX,restorationsweatforests.com,REJECT
DOMAIN-SUFFIX,dfberatcfobzr.online,REJECT
DOMAIN-SUFFIX,gxzkljfo.com,REJECT
DOMAIN-SUFFIX,oklajbxfhfmqa.site,REJECT
DOMAIN-SUFFIX,sediinklyldfm.site,REJECT
DOMAIN-SUFFIX,whfl95vxxgnz91onk3m3.cfd,REJECT
DOMAIN-SUFFIX,negrznhssmvfw.online,REJECT
DOMAIN-SUFFIX,corixapardie.qpon,REJECT
DOMAIN-SUFFIX,xmiggrrnkvrzf.online,REJECT
DOMAIN-SUFFIX,guanasegytling.shop,REJECT
DOMAIN-SUFFIX,ivvcvaqifiovl.space,REJECT
DOMAIN-SUFFIX,kidnapskilnman.qpon,REJECT
DOMAIN-SUFFIX,nemoscanteen.cyou,REJECT
DOMAIN-SUFFIX,guttingoutsat.com,REJECT
DOMAIN-SUFFIX,qwdomzftbuykr.site,REJECT
DOMAIN-SUFFIX,lanatoyasaeil.com,REJECT
DOMAIN-SUFFIX,jvqkmdzgbabzv.site,REJECT
DOMAIN-SUFFIX,pridingspaes.com,REJECT
DOMAIN-SUFFIX,cwjqiiehd.com,REJECT
DOMAIN-SUFFIX,moorhecuba.qpon,REJECT
DOMAIN-SUFFIX,pockymesons.shop,REJECT
DOMAIN-SUFFIX,adpopblzuma.in,REJECT
DOMAIN-SUFFIX,seggardhagmall.qpon,REJECT
DOMAIN-SUFFIX,lagansapician.com,REJECT
DOMAIN-SUFFIX,qwkfljghzcmsl.site,REJECT
DOMAIN-SUFFIX,ufrtqltsbqgqe.space,REJECT
DOMAIN-SUFFIX,balticalantol.cfd,REJECT
DOMAIN-SUFFIX,ygofdxgqlnptp.site,REJECT
DOMAIN-SUFFIX,tanachdesuvrecrimble.qpon,REJECT
DOMAIN-SUFFIX,rukgzuadsnmht.space,REJECT
DOMAIN-SUFFIX,frugginnetops.cfd,REJECT
DOMAIN-SUFFIX,hushbatingchinee.cyou,REJECT
DOMAIN-SUFFIX,ingressstowth.cfd,REJECT
DOMAIN-SUFFIX,paculch.shop,REJECT
DOMAIN-SUFFIX,ombxycak.com,REJECT
DOMAIN-SUFFIX,blufflysheatkevil.cfd,REJECT
DOMAIN-SUFFIX,limnerschaya.com,REJECT
DOMAIN-SUFFIX,llvlzvrejrzkj.top,REJECT
DOMAIN-SUFFIX,cocambgwyeeym.website,REJECT
DOMAIN-SUFFIX,curarasporrylieve.qpon,REJECT
DOMAIN-SUFFIX,disleafolearia.com,REJECT
DOMAIN-SUFFIX,wfsanqcmd.com,REJECT
DOMAIN-SUFFIX,yumvcqphmxpoh.site,REJECT
DOMAIN-SUFFIX,gwsfsdhplxa.com,REJECT
DOMAIN-SUFFIX,kewjptxneqwyg.space,REJECT
DOMAIN-SUFFIX,flammedbeet.shop,REJECT
DOMAIN-SUFFIX,dmxqacvbskeqg.site,REJECT
DOMAIN-SUFFIX,pottounlute.cyou,REJECT
DOMAIN-SUFFIX,bancadeltempoidea.org,REJECT
DOMAIN-SUFFIX,vyebzzqjkjmey.top,REJECT
DOMAIN-SUFFIX,lwohunbelndfn.space,REJECT
DOMAIN-SUFFIX,stummybegar.qpon,REJECT
DOMAIN-SUFFIX,hmnsqnvh.com,REJECT
DOMAIN-SUFFIX,unbearshowff.shop,REJECT
DOMAIN-SUFFIX,iijesqwojiykf.website,REJECT
DOMAIN-SUFFIX,mysellimbase.shop,REJECT
DOMAIN-SUFFIX,bqddrhvtnoikv.space,REJECT
DOMAIN-SUFFIX,plnkvbrdjzdl.com,REJECT
DOMAIN-SUFFIX,1b51d89cf3.com,REJECT
DOMAIN-SUFFIX,lounlenger.shop,REJECT
DOMAIN-SUFFIX,szfdojqawwoua.space,REJECT
DOMAIN-SUFFIX,northswindock.qpon,REJECT
DOMAIN-SUFFIX,diyhablzlnhuj.website,REJECT
DOMAIN-SUFFIX,xivkubru.in,REJECT
DOMAIN-SUFFIX,cwimdusmizcma.site,REJECT
DOMAIN-SUFFIX,chewerchauvin.com,REJECT
DOMAIN-SUFFIX,2ypqjxnzo.com,REJECT
DOMAIN-SUFFIX,jyinwqmzyh.com,REJECT
DOMAIN-SUFFIX,laqcroflisdvu.website,REJECT
DOMAIN-SUFFIX,nuggetyloggia.qpon,REJECT
DOMAIN-SUFFIX,fyyakrzubolls.online,REJECT
DOMAIN-SUFFIX,itxbnfhbnwbsn.online,REJECT
DOMAIN-SUFFIX,oscularlabella.com,REJECT
DOMAIN-SUFFIX,jhqumvnlupihm.site,REJECT
DOMAIN-SUFFIX,vpxviuxqiv.com,REJECT
DOMAIN-SUFFIX,amazuluheroins.cyou,REJECT
DOMAIN-SUFFIX,blintzehouser.qpon,REJECT
DOMAIN-SUFFIX,ejtaxdjeidkrr.site,REJECT
DOMAIN-SUFFIX,vudkqmlfrfrtf.site,REJECT
DOMAIN-SUFFIX,duendesmolest.com,REJECT
DOMAIN-SUFFIX,relineamuletscomox.qpon,REJECT
DOMAIN-SUFFIX,dghvspvswbqrp.site,REJECT
DOMAIN-SUFFIX,shrutibelace.cfd,REJECT
DOMAIN-SUFFIX,cytomachatons.cyou,REJECT
DOMAIN-SUFFIX,pastryhand.com,REJECT
DOMAIN-SUFFIX,myalgicknelt.com,REJECT
DOMAIN-SUFFIX,fhvfsitoizvah.online,REJECT
DOMAIN-SUFFIX,ransomssixtine.com,REJECT
DOMAIN-SUFFIX,invited.blueconferencefield.com,REJECT
DOMAIN-SUFFIX,totywedlock.shop,REJECT
DOMAIN-SUFFIX,repfineart.com,REJECT
DOMAIN-SUFFIX,seyipagkmopqv.com,REJECT
DOMAIN-SUFFIX,barattehairpin.qpon,REJECT
DOMAIN-SUFFIX,xxxmqvhpeorpa.site,REJECT
DOMAIN-SUFFIX,neifl.qpon,REJECT
DOMAIN-SUFFIX,ourangboomlet.cfd,REJECT
DOMAIN-SUFFIX,vradfvwfmwvaw.space,REJECT
DOMAIN-SUFFIX,gianthoppy.cyou,REJECT
DOMAIN-SUFFIX,mzwuwnrbpvyse.website,REJECT
DOMAIN-SUFFIX,prrexxpwa.com,REJECT
DOMAIN-SUFFIX,brawnergrice.shop,REJECT
DOMAIN-SUFFIX,chalkedsuttenlyrate.cyou,REJECT
DOMAIN-SUFFIX,qoyyovkpmdnvh.space,REJECT
DOMAIN-SUFFIX,aztmmnhpqzvln.online,REJECT
DOMAIN-SUFFIX,x8y8awcr.xyz,REJECT
DOMAIN-SUFFIX,wopsstocker.shop,REJECT
DOMAIN-SUFFIX,theorumgunj.cfd,REJECT
DOMAIN-SUFFIX,tugawhsvavbab.space,REJECT
DOMAIN-SUFFIX,ermittouters.shop,REJECT
DOMAIN-SUFFIX,halalasardeb.com,REJECT
DOMAIN-SUFFIX,ilbutylic.qpon,REJECT
DOMAIN-SUFFIX,xixnvwbokfztj.site,REJECT
DOMAIN-SUFFIX,avyagipiawmgk.website,REJECT
DOMAIN-SUFFIX,touzleclasses.cyou,REJECT
DOMAIN-SUFFIX,fleshedabody.com,REJECT
DOMAIN-SUFFIX,oeuvreshookeys.cyou,REJECT
DOMAIN-SUFFIX,heftierticks.com,REJECT
DOMAIN-SUFFIX,1mxw7zxyfzu91oi2ykwf9.cfd,REJECT
DOMAIN-SUFFIX,zpfdalzphoumr.online,REJECT
DOMAIN-SUFFIX,amylatedecesshoidens.cfd,REJECT
DOMAIN-SUFFIX,pedlarsnikkud.cfd,REJECT
DOMAIN-SUFFIX,hqheegsrbny.com,REJECT
DOMAIN-SUFFIX,upxawcgcqp.com,REJECT
DOMAIN-SUFFIX,fpldcfes.com,REJECT
DOMAIN-SUFFIX,ipxlwzvtmleub.site,REJECT
DOMAIN-SUFFIX,fflbmjgdjfsgt.site,REJECT
DOMAIN-SUFFIX,pqnbvaghxebvw.space,REJECT
DOMAIN-SUFFIX,cslcbabvxbbnr.site,REJECT
DOMAIN-SUFFIX,tnlxabgnzdzll.space,REJECT
DOMAIN-SUFFIX,dhhjflxgismkguk.com,REJECT
DOMAIN-SUFFIX,newsvehicles.com,REJECT
DOMAIN-SUFFIX,zfefrigcohme.in,REJECT
DOMAIN-SUFFIX,tinctsespier.cfd,REJECT
DOMAIN-SUFFIX,benchform.org,REJECT
DOMAIN-SUFFIX,stowsestapler.cfd,REJECT
DOMAIN-SUFFIX,elerxbfwrkwnb.site,REJECT
DOMAIN-SUFFIX,4hcp984mqygh3pt.cfd,REJECT
DOMAIN-SUFFIX,appromauts.qpon,REJECT
DOMAIN-SUFFIX,gruidaeauks.cfd,REJECT
DOMAIN-SUFFIX,hingepeeves.cyou,REJECT
DOMAIN-SUFFIX,reperklewdest.qpon,REJECT
DOMAIN-SUFFIX,detatterrene.qpon,REJECT
DOMAIN-SUFFIX,potassnomnem.qpon,REJECT
DOMAIN-SUFFIX,ojwecrhig.com,REJECT
DOMAIN-SUFFIX,hebeticcarinaluvular.qpon,REJECT
DOMAIN-SUFFIX,lwdipkupxshsz.online,REJECT
DOMAIN-SUFFIX,lilbzdxgelaih.online,REJECT
DOMAIN-SUFFIX,bwdhsqfsnouki.site,REJECT
DOMAIN-SUFFIX,awgiyrcpiqmf.com,REJECT
DOMAIN-SUFFIX,oilcakeleschemindel.qpon,REJECT
DOMAIN-SUFFIX,kuberacoruler.cfd,REJECT
DOMAIN-SUFFIX,ahdoiwnqxqwhe.online,REJECT
DOMAIN-SUFFIX,ugpexbthrsyak.space,REJECT
DOMAIN-SUFFIX,8uy9oc8g6gwm9l.rest,REJECT
DOMAIN-SUFFIX,affsvaaekwdyf.space,REJECT
DOMAIN-SUFFIX,rrfvhyjk5k2b5ujk3mpi9hrwqf.rest,REJECT
DOMAIN-SUFFIX,hyoswaxrtfvq.com,REJECT
DOMAIN-SUFFIX,ttybbmmtpmjqq.online,REJECT
DOMAIN-SUFFIX,misurabeachesakenes.qpon,REJECT
DOMAIN-SUFFIX,qqlbovjltdnoa.space,REJECT
DOMAIN-SUFFIX,overdidsivers.cyou,REJECT
DOMAIN-SUFFIX,uniomrtvmnf.com,REJECT
DOMAIN-SUFFIX,unfylmjytbkic.space,REJECT
DOMAIN-SUFFIX,lansingregush.com,REJECT
DOMAIN-SUFFIX,ccutanagfr.in,REJECT
DOMAIN-SUFFIX,dlftv.org,REJECT
DOMAIN-SUFFIX,295ormrf3pcyjrh1lfgj2y7hj5.cfd,REJECT
DOMAIN-SUFFIX,albandorje.cfd,REJECT
DOMAIN-SUFFIX,katcosuntkxbv.online,REJECT
DOMAIN-SUFFIX,gmkugvbctjet.com,REJECT
DOMAIN-SUFFIX,ztnkjzyjamwvj.space,REJECT
DOMAIN-SUFFIX,folsomtriesnyaya.cfd,REJECT
DOMAIN-SUFFIX,cdfplvpfymbyo.site,REJECT
DOMAIN-SUFFIX,emulsicnonya.cyou,REJECT
DOMAIN-SUFFIX,nsowfyxgqcxli.online,REJECT
DOMAIN-SUFFIX,mzcjystepddek.site,REJECT
DOMAIN-SUFFIX,nepoticamendsscrams.cfd,REJECT
DOMAIN-SUFFIX,cunanpoot.qpon,REJECT
DOMAIN-SUFFIX,onehi7qk5jvkw1fkr.rest,REJECT
DOMAIN-SUFFIX,etcbezan.shop,REJECT
DOMAIN-SUFFIX,nscgizlofgvnr.online,REJECT
DOMAIN-SUFFIX,metabitunbed.com,REJECT
DOMAIN-SUFFIX,janitorsemitic.shop,REJECT
DOMAIN-SUFFIX,qqrfjmgmkwfa.com,REJECT
DOMAIN-SUFFIX,obtundsfundus.qpon,REJECT
DOMAIN-SUFFIX,ithwjdzwwvotp.space,REJECT
DOMAIN-SUFFIX,tsbdthtol.com,REJECT
DOMAIN-SUFFIX,carnywhussle.qpon,REJECT
DOMAIN-SUFFIX,lvwgfqppnbg.com,REJECT
```
</details>
...
🩺 Shield模块: 健康检查通过（221562 条规则，10.2 MB）

✅ Shield 模块已写入，代理 27334 条，去广告 194228 条
...
- ✅ https://raw.githubusercontent.com/GMOogway/shadowrocket-rules/master/sr_direct_list.module
  - 成功 45 次，失败 0 次，连续失败 0 次
  - 最近成功: 2026-09-18 12:09:07
  - 最近失败: 无 

- ✅ https://raw.githubusercontent.com/GMOogway/shadowrocket-rules/master/sr_proxy_list.module
  - 成功 45 次，失败 0 次，连续失败 0 次
  - 最近成功: 2026-09-18 12:09:23
  - 最近失败: 无 
